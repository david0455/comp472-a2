...
def generate_children(current_puzzle_state):
    ...
    if row != 0:
        children.put((h1(copy_puzzle), getUp(current_puzzle_state), moveUp(copy_puzzle)))
    if row != len(current_puzzle_state) - 1:
        children.put((h1(copy_puzzle), getDown(current_puzzle_state), moveDown(copy_puzzle)))
    if col != 0:
        children.put((h1(copy_puzzle), getLeft(current_puzzle_state), moveLeft(copy_puzzle)))
    if col != len(current_puzzle_state[0]) - 1:
        children.put((h1(copy_puzzle), getRight(current_puzzle_state), moveRight(copy_puzzle)))
    ...
    or (row == len(current_puzzle_state) - 1 and col == len(current_puzzle_state[0]) - 1)):
        children.put((h1(copy_puzzle), getWrap(current_puzzle_state), moveWrap(copy_puzzle)))
        children.put((h1(copy_puzzle), getDiagonal(current_puzzle_state), moveDiagonal(copy_puzzle)))
        children.put((h1(copy_puzzle), getDiagWrap(current_puzzle_state), moveDiagWrap(copy_puzzle)))
    return children